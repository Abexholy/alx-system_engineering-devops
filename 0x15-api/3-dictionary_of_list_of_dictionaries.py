#!/usr/bin/python3
"""
A Python script that, using JSON PLACEHOLDER API,
for all employees and export data in the JSON format.
"""
import json
import requests
...
def export_all_to_json():
    """
    Gets data from JSON PLACEHOLDER API and writes them into json format.
    Return: None
    """
