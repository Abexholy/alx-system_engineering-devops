#!/usr/bin/python3
"""
Python script that, will be using the JSON PLACEHOLDER API,
for employee ID, export data in the CSV format.
"""
import requests
import sys
...
def export_to_csv(uid):
    """
    Gets JSON data PLACEHOLDER API and writes into csv format
    Args:
        uid: employee id
    Return: None
    """
