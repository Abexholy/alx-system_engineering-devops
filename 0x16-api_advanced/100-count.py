#!/usr/bin/python3
"""
Function queries the Reddit API and it prints
...
def count_words(subreddit, word_list, titles=[], after=None):
    """
    recursive function queries the Reddit API, parses the
    title of hot articles, and prints sorted count of
    the given keywords out
    """
    if after is None:
